...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The base namespace of the models.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Generated relationships directory
    |--------------------------------------------------------------------------
    |
    | The path to the generated relationships directory.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Generated relationships namespace
    |--------------------------------------------------------------------------
    |
    | The base namespace of the generated relationships.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Array of table names for which we don't want to generate models
    | and relationships.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Array of relationships we don't want to be generated, specified like this:
    |
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Array of "has one" relations instead of "has many", specified like this:
    |
